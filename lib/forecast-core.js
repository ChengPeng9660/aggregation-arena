// The 20-question daily slate produces 380 forecasts across Aggrena's current
// 19-model Fixed Context panel. Sixteen jobs per hourly cron can drain a full
// daily release with retry margin across the hourly schedule.
...
export const FORECAST_MODELS = [
  {
    participantId: "prophet-medium-gpt-5.6-sol",
  ...
  {
    participantId: "prophet-medium-gpt-5.5",
  ...
  {
    participantId: "prophet-medium-qwen-3.6-plus",
  ...
  {
    participantId: "prophet-medium-inkling",
  ...
  {
    participantId: "prophet-medium-muse-spark-1.1",
  ...
  {
    participantId: "prophet-medium-foresight-v3",
  ...
  if (normalizedModelId.startsWith("anthropic/") || normalizedModelId.startsWith("thinkingmachines/")) {
    return {
      ...
      ...(["anthropic/claude-fable-5", "anthropic/claude-opus-4.8"].includes(normalizedModelId)
        ? { output_config: { effort: FORECAST_REASONING_PROFILE }, thinking: { type: "adaptive" } }
        : {}),
    };
  }
