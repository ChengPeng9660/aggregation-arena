// Prophet Arena evaluates the complete frozen event slate instead of truncating
// a release to a small number of model-event jobs. Our five-domain slate holds
// at most 15 distinct events (3 per domain), so each scheduled round drains it.
export const FORECAST_EVENTS_PER_RUN = 15;
