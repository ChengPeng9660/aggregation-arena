import { evidenceCombinationProbability } from "./ec-core.js";
...
export function aggregateDistribution(forecasts, outcomeKeys, method, weights = []) {
  ...
  for (const key of keys) {
    ...
    else if (method === "ec-w0.56") output[key] = evidenceCombinationProbability(values);
    else if (method === "piecewise-odds") output[key] = piecewiseOddsProbability(values);
